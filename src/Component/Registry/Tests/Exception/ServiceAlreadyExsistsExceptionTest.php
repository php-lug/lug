 ...
 */
class ServiceAlreadyExsistsExceptionTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var ServiceAlreadyExistsException
     */
    private $exception;
    ...
    {
        $this->exception = new ServiceAlreadyExistsException();
    }
