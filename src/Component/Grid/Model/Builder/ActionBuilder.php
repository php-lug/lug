...
class ActionBuilder implements ActionBuilderInterface
{
    ...
    protected function buildName(array $config)
    {
        if (!isset($config['name'])) {
            throw new ConfigNotFoundException(sprintf('The action config "name" could not be found.'));
        }
    ...
    protected function buildType(array $config)
    {
        if (!isset($config['type'])) {
            throw new ConfigNotFoundException(sprintf('The action config "type" could not be found.'));
        }
