...
class FilterBuilder implements FilterBuilderInterface
{
    ...
    protected function buildName(array $config)
    {
        if (!isset($config['name'])) {
            throw new ConfigNotFoundException(sprintf('The filter config "name" could not be found.'));
        }
    ...
    protected function buildType(array $config)
    {
        if (!isset($config['type'])) {
            throw new ConfigNotFoundException(sprintf('The filter config "type" could not be found.'));
        }
